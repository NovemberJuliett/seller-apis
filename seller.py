...
def download_stock():
    ...
    Возвращает:
        list: список словарей с информацией об остатках часов
...
def create_stocks(watch_remnants, offer_ids):
    ...
    Возвращает:
        list: обновленный список товаров после сверки остатков часов с наличием товаров
        магазина на Озоне
...
def create_prices(watch_remnants, offer_ids):
    ...
    Возвращает:
        list: список словарей с ценами на товары
...
def divide(lst: list, n: int):
    ...
    Возвращает:
        list: список со списками по n элементов в каждом
